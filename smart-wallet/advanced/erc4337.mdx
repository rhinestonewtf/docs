...
Rhinestone uses its own intent infrastructure for most transactions, but some modules — [Social Recovery](./recovery) and legacy [Smart Sessions](../smart-sessions/overview) — require ERC-4337 UserOperations. This guide covers how to configure and use ERC-4337 with the SDK.
