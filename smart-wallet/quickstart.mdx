...
Create a smart account and send a crosschain transaction in a Node.js script — no browser, no wallet connection required.
...
<CardGroup cols={3}>
  <Card title="Sponsor gas" icon="fuel" href="./tutorials/sponsor-gas">
    Cover gas and bridging fees for your users across any chain.
  </Card>
