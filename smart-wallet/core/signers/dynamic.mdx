...
For [EIP-7702](/smart-wallet/7702/overview) with Dynamic's WaaS wallets, you need to create a custom viem account that wraps Dynamic's signer. This is because Dynamic's `signAuthorization` method uses a different interface than viem expects.
