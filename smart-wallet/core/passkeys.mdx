---
title: "Passkey"
description: "Use device biometrics as the owner of a smart account — single key or n/m multisig."
---
...
The WebAuthn Validator supports n/m multisig — multiple passkey owners with a configurable signature threshold.
...
By default, `threshold` is `1` — any single passkey can sign.
