---
title: "ECDSA Signer"
description: "Use an EOA as the owner of a smart account — single key or n/m multisig."
---
...
The Ownable Validator supports n/m multisig — multiple owners with a configurable signature threshold. This is useful for shared accounts, treasury management, or any scenario where unilateral control is a risk.
