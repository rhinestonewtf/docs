...
<Info>
The init signature is unique to the account address and only needs to be signed once. Always provide it when preparing a transaction, as the account may need to be deployed on any of the source or target chains.
</Info>
