...
* **Passkey**: use device biometrics to authorize transactions. [Learn more](./passkeys) about using passkeys.
* **Multisig**: use multiple signers of the same type to validate transactions. [Learn more](./multisig) about using multisigs.
