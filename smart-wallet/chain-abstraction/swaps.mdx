...
1) The account is deployed on [any chain](../../home/resources/supported-chains).
2) The account has at least one of the [supported assets](../../home/resources/supported-chains) on the chain with the deployed account.
