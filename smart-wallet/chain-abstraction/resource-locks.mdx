...
Learn more about the JIT flow and Resource Locking in our [conceptual guide](../../home/introduction/rhinestone-intents#dual-mode-execution).
...
There are two ways to unlock: using permissionless and instant withdrawals.

#### Permissionless Withdrawals

Permissionless withdrawals are two-step: you first need to enable the withdrawal, then wait for an unlock (reset) period, and do the actual withdrawal.
