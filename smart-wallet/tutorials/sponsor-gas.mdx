...
This tutorial builds on [Tutorial 1](./setting-up-smart-account). You'll need a working smart account setup before continuing.

## Prerequisites

- Completed [Build your first smart wallet](./setting-up-smart-account)
...
<CardGroup cols={2}>
  <Card title="Gas sponsorship reference" href="../gas-sponsorship/overview">
    Full details on fee types, policies, and how sponsorship is calculated.
  </Card>

  <Card title="Smart account setup" href="../core/setup-signer">
    Customise your signer — passkeys, embedded wallets, multi-factor auth.
  </Card>

  <Card title="Smart Sessions" href="../smart-sessions/overview">
