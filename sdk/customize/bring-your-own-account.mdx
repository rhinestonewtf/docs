...
By default, Rhinestone SDK deploys a new smart account. You can reuse smart accounts you've already created for your users (for example, using another SDK) by providing custom deployment data.
...
Unless you were using the V0 SDK before, the accounts you have won't have the Rhinestone intent executor installed.
