...
<Note>The example below generates a private key for demonstration purposes. For production apps, consider using embedded wallet providers like [Privy](./core/embedded-signers/privy), [Dynamic](./core/embedded-signers/dynamic), or [Turnkey](./core/embedded-signers/turnkey) to handle user onboarding and key management.</Note>
