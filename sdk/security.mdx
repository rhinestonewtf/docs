...
When you obtain an API key from the Rhinestone dashboard and fund sponsorship there, any client that embeds this key directly can be abused: an attacker could exfiltrate the key and use the Orchestrator to sponsor their own transactions.
