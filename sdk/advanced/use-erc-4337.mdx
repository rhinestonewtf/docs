...
Rhinestone is compatible with ERC-4337. Some smart account modules, such as [Social Recovery](../smart-wallet/social-recovery) and legacy [Smart Sessions](../smart-sessions/overview), will require useroperations. This guide provides a quick overview of how to use ERC-4337 with the Rhinestone SDK.
