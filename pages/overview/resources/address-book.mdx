...
<div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-1">
  ...
  <p className="m-0">• Optimism</p>
  <p className="m-0">• Arbitrum</p>
  <p className="m-0">• Base</p>
  <p className="m-0">• Polygon</p>
  <p className="m-0">• Avalanche</p>
  <p className="m-0">• Gnosis</p>
  <p className="m-0">• Scroll</p>
  <p className="m-0">• Fuse</p>
...
<div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-1">
  <p className="m-0">• Sepolia</p>
  <p className="m-0">• Optimism Sepolia</p>
  <p className="m-0">• Arbitrum Sepolia</p>
  <p className="m-0">• Base Sepolia</p>
  <p className="m-0">• Polygon Amoy</p>
  <p className="m-0">• Avalanche Fuji</p>
  <p className="m-0">• Scroll Sepolia</p>
  <p className="m-0">• Fuse Spark</p>
  <p className="m-0">• BSC Testnet</p>
</div>
