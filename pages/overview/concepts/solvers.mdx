...
## Features facilitated by Omni Account Solvers
...
To view a reference implementation of a solver, check out [our Rhinestone Relayer repository](https://github.com/rhinestonewtf/rhinestone-relayer). The solver is a simple Across solver that has been adapted to fill Omni Account intents. Note that this repo is still a work in progress, and better documentation will follow soon.
