...
Modules are self-contained smart contracts that extend a smart account's feature set. This allows developers to access the programmable validation and execution of smart accounts, allowing teams to build custom components or reuse modules built by other developers.
...
[Core Modules Repository](../../sdk/core-setup/core-modules)
