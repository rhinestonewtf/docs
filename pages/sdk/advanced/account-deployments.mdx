...
On the source chain, you can either use an ERC-4337 bundler or a separate _deployer_ EOA to deploy.

## Using a bundler

By default, accounts are deployed with an ERC-4337 bundler. This requires the account to be prefunded on the source chain with ETH to pay for gas.
