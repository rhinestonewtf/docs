...
Call policy allows to filter out actions based on the call data and ether value.
...
In other words, if the offset is 10, the compared value will be formed from the call data with the starting index of `4 + 10 = 14` and an end index of `4 + 10 + 32 = 46`.

## Reference Value

Value to compare the call data against to.
