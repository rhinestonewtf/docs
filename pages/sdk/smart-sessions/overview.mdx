...
- [Call](./policies/call): allows actions with the specified calldata
- [Spending limit](./policies/spending-limit): allows a limited value of ERC20 tokens to be transferred and approved
- [Timeframe](./policies/timeframe): allows actions within the specified time frame
- [Usage limit](./policies/usage-limit): allows a limited number of actions
- Value limit: allows a limited amount of ETH value transfered
