...
<CardGroup cols={2}>
  <Card title="Setup" icon="settings" href="/deposits/api/setup">
    Webhooks, sponsorship rules, and deposit whitelists.
  </Card>
  <Card title="Registering accounts" icon="user-plus" href="/deposits/api/registering-accounts">
    User-owned accounts, session configuration, and output token rules.
  </Card>
  <Card title="Processing deposits" icon="arrow-right-left" href="/deposits/api/processing-deposits">
