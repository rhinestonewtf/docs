...
- Modular **Smart Account** toolkit, compatible with all major [key management solutions](../../sdk/smart-wallet/signers/dynamic)
...
Rhinestone provides a modular intent engine that aggregates existing crosschain settlement layers through a unified relayer market. It utilizes resource locks for blazing fast crosschain execution and a sophisticated offchain solver for routing, transaction encoding, and orchestration.
...
More on [Rhinestone Intents](./rhinestone-intents).
