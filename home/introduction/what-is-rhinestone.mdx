...
- Modular **Smart Account** toolkit, compatible with all major [embedded wallet signers](../../smart-wallet/core/signers/dynamic)
...
<Columns cols={2}>
  <Card title="Quickstart" icon="circle-chevron-right" href="../../smart-wallet/quickstart">
