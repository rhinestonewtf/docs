...
<img
  ...
  src="/images/teams_that_build_with_us_light.png"
/>

<img
  className="hidden dark:block"
  src="/images/teams_that_build_with_us_dark.png"
/>
...
<div className='grid grid-cols-1 md:grid-cols-3 gap-x-2'>
  ...
  <Card title="Session Keys" href="../../sdk/smart-sessions/overview" img="../../images/cards/smart_sessions.png">
...
<div className='grid grid-cols-1 md:grid-cols-3 gap-x-2'>
  <Card title="Create First Transaction" href="../../sdk/smart-wallet/create-first-transaction" img="../../images/cards/omnichain_transactions.png">
  Embed crosschain intents into your application
  </Card>
  <Card title="Swaps" href="../../sdk/intents/swaps" img="../../images/cards/omnichain_swaps.png">
  Perform instant crosschain swap intents
  </Card>
  <Card title="API Reference" href="../../api-reference/user/get-user-portfolio" img="../../images/cards/api_reference.png">
