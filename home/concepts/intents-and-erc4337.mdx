...
mode: "wide"
description: "How ERC-7683 intents compare to ERC-4337 userops, and what makes intent-based execution different."
---
...
ERC-7683 defines a standard order struct and settlement interface for intents. By standardizing how intent systems describe and settle orders, it allows solvers to participate across multiple intent systems, increases liquidity competition, and makes it easier to switch providers.
...
| Feature | ERC-4337 (userops) | ERC-7683 (Intents) |
| :--- | :--- | :--- |
...
As ERC-7683 adoption grows, switching providers becomes simpler and solver competition increases.
