...
<Info>
  A subset of core modules are integrated into the Rhinestone SDK. For the full module library, see the [Module SDK](https://github.com/rhinestonewtf/module-sdk) or [core-modules](https://github.com/rhinestonewtf/core-modules) repository.
</Info>
