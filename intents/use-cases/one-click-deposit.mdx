...
```mermaid
sequenceDiagram
    participant User as User EOA<br/>(userAddress)
    participant Companion as Companion Account<br/>(companionAccount.getAddress())
    participant Recipient as Deposit Destination<br/>(recipient)
