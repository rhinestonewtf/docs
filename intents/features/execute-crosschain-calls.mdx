---
title: "Execute crosschain calls (new)"
sidebarTitle: "Execute crosschain calls (new)"
...
<CardGroup cols={2}>
  ...
  <Card title="Multi-input bridge" icon="arrow-right-left" href="./multi-input-bridge">
