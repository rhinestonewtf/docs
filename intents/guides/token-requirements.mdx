...
As part of the [quote](./getting-a-quote), you usually receive a list of token requirements. These requirements can span across multiple chains and tokens.
...
2. WETH (from the first step) must be approved for the [Permit2](https://github.com/Uniswap/permit2) contract on Base.
