...
Warp is using legible signing with [EIP-712](https://eips.ethereum.org/EIPS/eip-712).

## Preparing the payload

First, let's convert the intent operation received from the API into a typed message to sign.
...
Once you have the typed data, you can request the user to sign it with their wallet.

Note that you'll need to sign every element of the intent (1 signature per input chain).
