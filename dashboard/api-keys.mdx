...
<Warning>You won't be able to see this key again. If you lose it, revoke it and create a new one.</Warning>
...
<Warning>Revoking takes effect immediately — all traffic signed with that key is rejected. If it's the only active key on the project, traffic stops until you create a new one.</Warning>
