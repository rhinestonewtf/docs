...
After signing in you land on your project's Overview. The sidebar holds the main sections:

- **Overview** — volume, intents, deposits, and app-fee revenue for the project.
...
- **Settings** — team, sponsorship balance, app fees, and team activity.
