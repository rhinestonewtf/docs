...
<Warning>The private key is shown once and can't be recovered. If you lose it, disable the key and register a new one.</Warning>
...
<Warning>Disabling takes effect immediately — tokens signed with that key are rejected right away.</Warning>
